...
public class SavingsAccountTest {
    ...
    public void test02_HappyPath_Tests() throws IllegalAccessException, InvocationTargetException, InstantiationException, NoSuchMethodException {
        ...
        assertEquals(testAccountHolderName, twoArgGetAccountHolderName.invoke(twoArgInstance),
                SAVINGS_ACCOUNT_CLASS_NAME + " constructor " + SAVINGS_ACCOUNT_CLASS_NAME + "(String, String) does not correctly set the field accountHolderName.");
        ...
        assertEquals(testAccountNumber, twoArgGetAccountNumber.invoke(twoArgInstance),
                SAVINGS_ACCOUNT_CLASS_NAME + " constructor " + SAVINGS_ACCOUNT_CLASS_NAME + "(String, String) does not correctly set the field accountNumber.");
        ...
        assertEquals(testAccountHolderName, threeArgGetAccountHolderName.invoke(threeArgInstance), SAVINGS_ACCOUNT_CLASS_NAME + " constructor " + SAVINGS_ACCOUNT_CLASS_NAME + "(String, String, int) does not correctly set the field accountHolderName.");
        ...
        assertEquals(testAccountNumber, threeArgGetAccountNumber.invoke(threeArgInstance),
                SAVINGS_ACCOUNT_CLASS_NAME + " constructor " + SAVINGS_ACCOUNT_CLASS_NAME + "(String, String, int) does not correctly set the field accountNumber.");
        ...
        assertEquals(testBalance, threeArgGetBalance.invoke(threeArgInstance),
                SAVINGS_ACCOUNT_CLASS_NAME + " constructor " + SAVINGS_ACCOUNT_CLASS_NAME + "(String, String, int) does not correctly set the field balance.");
        ...
        assertEquals(withdrawExpectedReturnValue, withdrawActualReturnValue,
                SAVINGS_ACCOUNT_CLASS_NAME + " withdraw method fails to decrease balance by correct amount. Starting balance: " + testBalance + ", withdraw: " + withdrawParamValue + ", new balance should be " + withdrawExpectedReturnValue + ".");
    }
    ...
    public void test03_EdgeCase_Tests() throws IllegalAccessException, InvocationTargetException, InstantiationException {
        ...
        assertEquals(150, balance, SAVINGS_ACCOUNT_CLASS_NAME + " withdraw method fails to decrease balance by correct amount. Starting balance: 200, withdraw: 50, new balance should be 150 (200 - 50 = 150).");
        ...
        assertEquals(147, balance, SAVINGS_ACCOUNT_CLASS_NAME + " withdraw method fails to decrease balance by correct amount. Starting balance: 200, withdraw: 51, new balance should be 147 (200 - (51 + 2 fee) = 147).");

        // Assert withdrawal of 198 dollars from 200 allows withdrawal and assesses fee
        savingsAccount = threeArgConstructor.newInstance("", "", 200);
        withdraw.invoke(savingsAccount, 198);
        balance = getBalance.invoke(savingsAccount);
        assertEquals(0, balance, SAVINGS_ACCOUNT_CLASS_NAME + " withdraw method fails to decrease balance by correct amount. Starting balance: 200, withdraw: 198, new balance should be 0 (200 - (198 + 2 fee) = 0).");

        // Assert withdrawal of 199 dollars from 200 denies withdrawal but no fee
        savingsAccount = threeArgConstructor.newInstance("", "", 200);
        withdraw.invoke(savingsAccount, 199);
        balance = getBalance.invoke(savingsAccount);
        assertEquals(200, balance, SAVINGS_ACCOUNT_CLASS_NAME + " withdraw method fails to decrease balance by correct amount. Starting balance: 200, withdraw: 199, overdraft should be denied (200 - (199 + 2 fee) < 0) and balance remains 200.");

        // Assert can't deposit a negative amount
        savingsAccount = threeArgConstructor.newInstance("", "", 100);
        deposit.invoke(savingsAccount, -10);
        balance = getBalance.invoke(savingsAccount);
        assertEquals(100, balance, SAVINGS_ACCOUNT_CLASS_NAME + " deposit method fails to prevent negative deposit amount. Starting balance: 100, deposit: -10, balance should remain at 100.");

        // Assert can't withdraw a negative amount
        savingsAccount = threeArgConstructor.newInstance("", "", 100);
        withdraw.invoke(savingsAccount, -10);
        balance = getBalance.invoke(savingsAccount);
        assertEquals(100, balance, SAVINGS_ACCOUNT_CLASS_NAME + " withdraw method fails to prevent negative withdraw amount. Starting balance: 100, withdraw: -10, balance should remain at 100.");
    }
