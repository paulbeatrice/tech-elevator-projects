...
public class Step5_IsVipTest {
    ...
    public void test02_HappyPathTests() throws InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        assertFalse((Boolean)isVipReturnValue,
                BANK_CUSTOMER_CLASS_NAME + " method " + METHOD_NAME + " should return false for one account with total balance under VIP amount of " + VIP_AMOUNT + ". " +
        ...
        assertTrue((Boolean)isVipReturnValue,
                BANK_CUSTOMER_CLASS_NAME + " method " + METHOD_NAME + " should return true for one account with total balance over VIP amount of " + VIP_AMOUNT + ". " +
                        "BankAccount balance: " + bankAccount.getBalance());
        ...
        isVipReturnValue = isVip.invoke(bankCustomerInstance);
        assertFalse((Boolean)isVipReturnValue,
                BANK_CUSTOMER_CLASS_NAME + " method " + METHOD_NAME + " should return false for two accounts with total balance under VIP amount of " + VIP_AMOUNT + ". " +
        ...
        isVipReturnValue = isVip.invoke(bankCustomerInstance);
        assertTrue((Boolean)isVipReturnValue,
                BANK_CUSTOMER_CLASS_NAME + " method " + METHOD_NAME + " should return true for two accounts with total balance over VIP amount of " + VIP_AMOUNT + ". " +
                        "BankAccount balance: " + bankAccount.getBalance() + ", CheckingAccount balance: " + checkingAccount.getBalance() + ", Total: " + (bankAccount.getBalance() + checkingAccount.getBalance()));
        ...
        isVipReturnValue = isVip.invoke(bankCustomerInstance);
        assertFalse((Boolean)isVipReturnValue,
                BANK_CUSTOMER_CLASS_NAME + " method " + METHOD_NAME + " should return false for three accounts with total balance under VIP amount of " + VIP_AMOUNT + ". " +
        ...
        isVipReturnValue = isVip.invoke(bankCustomerInstance);
        assertTrue((Boolean)isVipReturnValue,
                BANK_CUSTOMER_CLASS_NAME + " method " + METHOD_NAME + " should return true for three accounts with total balance over VIP amount of " + VIP_AMOUNT + ". " +
                        "BankAccount balance: " + bankAccount.getBalance() + ", CheckingAccount balance: " + checkingAccount.getBalance() + ", SavingsAccount balance: " + savingsAccount.getBalance() + ", Total: " + (bankAccount.getBalance() + checkingAccount.getBalance() + savingsAccount.getBalance()));
        ...
        isVipReturnValue = isVip.invoke(bankCustomerInstance);
        assertFalse((Boolean)isVipReturnValue,
                BANK_CUSTOMER_CLASS_NAME + " method " + METHOD_NAME + " should return false for one credit card account with total balance under VIP amount of " + VIP_AMOUNT + ". " +
        ...
        isVipReturnValue = isVip.invoke(bankCustomerInstance);
        assertFalse((Boolean)isVipReturnValue,
                BANK_CUSTOMER_CLASS_NAME + " method " + METHOD_NAME + " should return false for one bank account and one credit card account with total balance under VIP amount of " + VIP_AMOUNT + ". " +
        ...
        isVipReturnValue = isVip.invoke(bankCustomerInstance);
        assertTrue((Boolean)isVipReturnValue,
                BANK_CUSTOMER_CLASS_NAME + " method " + METHOD_NAME + " should return true for one bank account and one credit card account with total balance over VIP amount of " + VIP_AMOUNT + ". " +
        ...
        isVipReturnValue = isVip.invoke(bankCustomerInstance);
        assertFalse((Boolean)isVipReturnValue,
                BANK_CUSTOMER_CLASS_NAME + " method " + METHOD_NAME + " should return false for two bank accounts and one credit card account with total balance under VIP amount of " + VIP_AMOUNT + ". " +
        ...
        isVipReturnValue = isVip.invoke(bankCustomerInstance);
        assertTrue((Boolean)isVipReturnValue,
                BANK_CUSTOMER_CLASS_NAME + " method " + METHOD_NAME + " should return true for two bank accounts and one credit card account with total balance over VIP amount of " + VIP_AMOUNT + ". " +
        ...
        isVipReturnValue = isVip.invoke(bankCustomerInstance);
        assertFalse((Boolean)isVipReturnValue,
                BANK_CUSTOMER_CLASS_NAME + " method " + METHOD_NAME + " should return false for one bank accounts and two credit card accounts with total balance under VIP amount of " + VIP_AMOUNT + ". " +
        ...
        isVipReturnValue = isVip.invoke(bankCustomerInstance);
        assertTrue((Boolean)isVipReturnValue,
                BANK_CUSTOMER_CLASS_NAME + " method " + METHOD_NAME + " should return true for one bank accounts and two credit card accounts with total balance over VIP amount of " + VIP_AMOUNT + ". " +
    ...
    public void test03_EdgeCaseTests() throws InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        Object isVipReturnValue = isVip.invoke(bankCustomerInstance);
        assertFalse((boolean)isVipReturnValue,
                BANK_CUSTOMER_CLASS_NAME + " method " + METHOD_NAME + " should return false for one account with total balance one dollar under VIP amount of " + VIP_AMOUNT + ". " +
                        "BankAccount balance: " + bankAccount.getBalance() + "");
        ...
        isVipReturnValue = isVip.invoke(bankCustomerInstance);
        assertTrue((Boolean)isVipReturnValue,
                BANK_CUSTOMER_CLASS_NAME + " method " + METHOD_NAME + " should return true for one account with total balance exactly the VIP amount of " + VIP_AMOUNT + ". " +
                        "BankAccount balance: " + bankAccount.getBalance() + "");
        ...
        isVipReturnValue = isVip.invoke(bankCustomerInstance);
        assertFalse((Boolean)isVipReturnValue,
                BANK_CUSTOMER_CLASS_NAME + " method " + METHOD_NAME + " should return false for two accounts with total balance one dollar under the VIP amount of " + VIP_AMOUNT + ". " +
                        "BankAccount balance: " + bankAccount.getBalance() + ", CheckingAccount balance: " + checkingAccount.getBalance() + ", Total: " + (bankAccount.getBalance() + checkingAccount.getBalance()));
        ...
        isVipReturnValue = isVip.invoke(bankCustomerInstance);
        assertTrue((Boolean)isVipReturnValue,
                BANK_CUSTOMER_CLASS_NAME + " method " + METHOD_NAME + " should return true for two accounts with total balance exactly the VIP amount of " + VIP_AMOUNT + ". " +
                        "BankAccount balance: " + bankAccount.getBalance() + ", CheckingAccount balance: " + checkingAccount.getBalance() + ", Total: " + (bankAccount.getBalance() + checkingAccount.getBalance()));
        ...
        isVipReturnValue = isVip.invoke(bankCustomerInstance);
        assertFalse((Boolean)isVipReturnValue,
                BANK_CUSTOMER_CLASS_NAME + " method " + METHOD_NAME + " should return false for two bank accounts and one credit card account with total balance one dollar under the VIP amount of " + VIP_AMOUNT + ". " +
        ...
        isVipReturnValue = isVip.invoke(bankCustomerInstance);
        assertTrue((Boolean)isVipReturnValue,
                BANK_CUSTOMER_CLASS_NAME + " method " + METHOD_NAME + " should return true for two bank accounts and one credit card account with total balance exactly the VIP amount of " + VIP_AMOUNT + ". " +
                        "BankAccount balance: " + bankAccount.getBalance() + ", CheckingAccount balance: " + checkingAccount.getBalance() + ", CreditCardAccount balance: -1, Total: " + (bankAccount.getBalance() + checkingAccount.getBalance() - 1));
    }
