...
public class Step4_BankCustomerTest {
    ...
    public void test02_HappyPathTests() throws InvocationTargetException, InstantiationException, IllegalAccessException, NoSuchMethodException {
        ...
        assertEquals(testName, getName.invoke(instance),
                BANK_CUSTOMER_CLASS_NAME + " does not correctly set the field name.");
        ...
        assertEquals(testAddress, getAddress.invoke(instance),
                BANK_CUSTOMER_CLASS_NAME + " does not correctly set the field address.");
        ...
        assertEquals(testPhoneNumber, getPhoneNumber.invoke(instance),
                BANK_CUSTOMER_CLASS_NAME + " does not correctly set the field phoneNumber.");
        ...
        assertTrue(areListsEqual(createListOfAccountables(false), getAccountsReturnValue),
                BANK_CUSTOMER_CLASS_NAME + " getAccounts method fails to return the expected list.");
        ...
        assertTrue(areListsEqual(createListOfAccountables(true), accountsFieldValue),
                BANK_CUSTOMER_CLASS_NAME + " addAccount method fails to add the expected account to the list.");
    }
