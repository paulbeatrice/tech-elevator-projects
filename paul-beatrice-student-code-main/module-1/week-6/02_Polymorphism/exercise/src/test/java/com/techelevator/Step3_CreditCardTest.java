...
public class Step3_CreditCardTest {
    ...
    public void test02_HappyPathTests() throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        assertEquals(testAccountHolderName, getAccountHolderName.invoke(instance),
                CREDIT_CARD_ACCOUNT_CLASS_NAME + " constructor " + CREDIT_CARD_ACCOUNT_CLASS_NAME + "(String, String) does not correctly set the field accountHolderName.");
        Method getCardNumber = instance.getClass().getMethod("getCardNumber");
        assertEquals(testCardNumber, getCardNumber.invoke(instance),
                CREDIT_CARD_ACCOUNT_CLASS_NAME + " constructor " + CREDIT_CARD_ACCOUNT_CLASS_NAME + "(String, String) does not correctly set the field cardNumber.");
        Method getDebt = instance.getClass().getMethod("getDebt");
        assertEquals(0, getDebt.invoke(instance),
                CREDIT_CARD_ACCOUNT_CLASS_NAME + " constructor " + CREDIT_CARD_ACCOUNT_CLASS_NAME + "(String, String) does not correctly default debt to 0.");
        ...
        assertEquals(testDebt * -1, (int)instanceBalance,
                CREDIT_CARD_ACCOUNT_CLASS_NAME + " field balance must equal the debt value as a negative number.");
        ...
        assertEquals(payExpectedReturnValue, payActualReturnValue,
                CREDIT_CARD_ACCOUNT_CLASS_NAME + " pay method fails to decrease debt by correct amount. Starting debt: " + testDebt + ", pay: " + payParamValue + ", new debt should be " + payExpectedReturnValue + ".");
        ...
        assertEquals(chargeExpectedReturnValue, chargeActualReturnValue,
                CREDIT_CARD_ACCOUNT_CLASS_NAME + " charge method fails to increase debt by correct amount. Starting debt: " + payExpectedReturnValue + ", charge: " + chargeParamValue + ", new debt should be " + chargeExpectedReturnValue + ".");
    }
    ...
    public void test03_EdgeCaseTests() throws InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        assertEquals(0, debt,
                CREDIT_CARD_ACCOUNT_CLASS_NAME + " pay method fails to decrease debt by correct amount. Starting debt: 1, pay: 1, new debt should be 0.");
        ...
        assertEquals(1, debt,
                CREDIT_CARD_ACCOUNT_CLASS_NAME + " charge method fails to increase debt by correct amount. Starting debt: 0, charge: 1, new debt should be 1.");
        ...
        debt = getDebt.invoke(account);
        assertEquals(0, debt,
                CREDIT_CARD_ACCOUNT_CLASS_NAME + " pay method fails to prevent negative pay amount. Starting debt: 0, pay: -10, debt should remain at 0.");
        ...
        assertEquals(10, debt,
                CREDIT_CARD_ACCOUNT_CLASS_NAME + " charge method fails to prevent negative charge amount. Starting debt: 10, charge: -10, debt should remain at 10.");
    }
