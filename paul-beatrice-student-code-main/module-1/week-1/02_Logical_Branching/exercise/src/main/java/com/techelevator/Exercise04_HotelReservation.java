...
public class Exercise04_HotelReservation {
    ...
    public double calculateStayTotal(int numberOfNights) {
        if (numberOfNights <=2) {
            return 99.99 * numberOfNights;
        }
        if (numberOfNights >=3) {
            return 89.99 * numberOfNights;
        }
        return 0.0;
    }
    ...
    public double calculateStayTotal(int numOfTotalNights, boolean includesParking) {
        if (numOfTotalNights >=3 && includesParking) {
            return (89.99 * numOfTotalNights) + (25.00 * numOfTotalNights);
        }
        if (numOfTotalNights >=3 && !includesParking) {
            return (89.99 * numOfTotalNights);
        }
        if (numOfTotalNights <3 && includesParking) {
            return (99.99 * numOfTotalNights) + (25.00 * numOfTotalNights);
        }
        if (numOfTotalNights <3 && !includesParking) {
            return (99.99 * numOfTotalNights);
        }
        return 0.0;
    }
    ...
    public double calculateStayTotal(int numOfTotalNights, boolean includesParking, boolean includesLateCheckout) {
        if (numOfTotalNights >=3 && includesParking && includesLateCheckout) {
            return (89.99 * numOfTotalNights) + (25.00 * numOfTotalNights) + LATE_CHECKOUT_FEE;
        }
        if (numOfTotalNights >=3 && includesParking && !includesLateCheckout) {
            return (89.99 * numOfTotalNights) + (25.00 * numOfTotalNights);
        }
        if (numOfTotalNights >=3 && !includesParking && includesLateCheckout) {
            return (89.99 * numOfTotalNights) + LATE_CHECKOUT_FEE;
        }
        if (numOfTotalNights >=3 && !includesParking && !includesLateCheckout) {
            return (89.99 * numOfTotalNights);
        }
        ...
        if (numOfTotalNights <3 && includesParking && includesLateCheckout) {
            return (99.99 * numOfTotalNights) + (25.00 * numOfTotalNights) + LATE_CHECKOUT_FEE;
        }
        if (numOfTotalNights <3 && !includesParking && includesLateCheckout) {
            return (99.99 * numOfTotalNights) + LATE_CHECKOUT_FEE;
        }
        if (numOfTotalNights <3 && !includesParking && !includesLateCheckout) {
            return (99.99 * numOfTotalNights);
        }
