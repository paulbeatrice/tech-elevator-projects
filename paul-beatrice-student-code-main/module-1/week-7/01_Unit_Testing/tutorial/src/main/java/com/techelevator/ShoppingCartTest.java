...
public class ShoppingCartTest {
    ...
    public void getTax_should_return_tax_on_taxable_items() {
        //Arrange - the @BeforeEach method create a cart before every test

        //Act - get the tax
        double tax = cart.getTax();

        //Assert - make sure values is correct
    ...
    public void getTotalPrice_should_return_sum_of_items_plus_tax() {
        ...
        //Assert- Make sure the value is correct
        assertEquals(43.00, total, 0.001, "did not return the correct cart total"); //delta = 0.001
    }
