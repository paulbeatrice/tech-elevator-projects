...
public class Exercise04_Cards {
    ...
    */
    ...
    public String[] discardTopCard(String[] remainingDeck) {
        ...
        String[] newDeck = new String[remainingDeck.length - 1]; // output is one smaller than input[} (remaining deck)

        // output[] : null, null, null



        System.arraycopy(remainingDeck, 1, newDeck, 0 , remainingDeck.length -1);
