...
public class Exercise03_Shirts {
    ...
    public char[] buildOrder() {
        ...
        char[] buildOrder = {SMALL_TSHIRT, SMALL_TSHIRT, SMALL_TSHIRT, MEDIUM_TSHIRT, MEDIUM_TSHIRT,LARGE_TSHIRT};
        return buildOrder;
    ...
    public char[] buildBulkOrder(int numberOfShirts) {
        ...
        char[] sizesGroup = {SMALL_TSHIRT, MEDIUM_TSHIRT, LARGE_TSHIRT};
        char[] buildBulkOrder = new char[numberOfShirts];

        for (int i=0; i < numberOfShirts; i++){
            buildBulkOrder[i]=sizesGroup[i % sizesGroup.length];
