...
import { faCartPlus, faTrashCan, faXmark, faMagnifyingGlass, faRotate, faTable, faGrip, faUser, faPlane }  //added fa icons
...
library.add(faTable);
library.add(faGrip);
library.add(faUser);  // had to also add the Icons Here
library.add(faPlane);
