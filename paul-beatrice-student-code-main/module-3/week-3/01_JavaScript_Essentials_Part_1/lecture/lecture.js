...
//0, NaN, "", false, null, undefined are all false......everythng else is true
if (NaN) {
...
// .substring(beginIndex, endIndex) ----> EXACTLY SAME AS JAVA!
...
const variableHoldingTheFuction = helloWorld;
const output1 = variableHoldingTheFuction(5);
console.log(output1);

// Declare a `sayHello` function that accepts a name parameter

function sayHello(yourName = 'Paul Beatrice') {
  console.log("Hello, " + yourName + " (concatentation) "); //String concatentation
...
sayHello("Paul", "Bobby", "Gauntlet", "Eddie");
sayHello();
