...
describe('Component Communication Exercise', () => {
  ...
  describe("Step Three Tests", () => {
    ...
    it('should mark book as read when "Mark Read" button is pressed', () => {
      ...
      cy.get("div.card:has(> .mark-read:visible)").as("card");
      ...
      cy.get("div.card.read:has(> .mark-unread:visible)").should("have.length", 4);
    ...
    it('should mark book as unread when "Mark Unread" button is pressed', () => {
      ...
      cy.get("div.card:has(> .mark-unread:visible)").as("card");
      ...
      cy.get("div.card:not(.read):has(> .mark-read:visible)").should("have.length", 4);
    });
  });
