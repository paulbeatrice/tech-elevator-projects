package com.techelevator.customproject;
//
//import com.techelevator.customproject.dao.*;
//import com.techelevator.customproject.exception.DaoException;
//import com.techelevator.customproject.model.*;
...
//
//    public Controller(BasicConsole console, CustomerDao customerDao, ProductDao productDao, SaleDao saleDao, LineItemDao lineItemDao) {
...
//        List<LineItem> lineItems = lineItemDao.getLineItemsBySaleId(sale.getSaleId());
...
//        List<Sale> sales = saleDao.getUnshippedSales(); // You can't delete a completed order
//
//        // Inform the user if there are no qualifying sales
//        if (sales.size() == 0) {
//            // Nothing can be shipped because there are no unshipped orders
