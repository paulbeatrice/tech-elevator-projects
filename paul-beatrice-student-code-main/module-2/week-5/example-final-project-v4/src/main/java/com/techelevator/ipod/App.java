...
import com.techelevator.ipod.dao.JdbcSongDao;
...
//        now.toString()
        ...
        dataSource.setUrl("jdbc:postgresql://localhost:5432/ipod");
        dataSource.setUsername("postgres");
        dataSource.setPassword("postgres1");

        JdbcSongDao songDao = new JdbcSongDao(dataSource);
