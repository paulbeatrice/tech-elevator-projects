...
-- 1
 ('Taylor Galtone', '59 Bultman Street', 'Apt 1708', 'Cedar Rapids', 'IA', '52401'),
-- 2
 ('Ash DiBiaggi', '95 Acker Parkway', null, 'Denver', 'CO', '80203'),
-- 3
 ('Kanta Balling', '923 Bay Point', 'Suite 8', 'Kansas City', 'MO', '64108'),
-- 4
 ('Jule Gregor', '64848 Mesta Circle', null, 'Charlotte', 'NC', '28202'),
-- 5
 ('Steph Moxley', '363 Russell Terrace', 'Apt 1577', 'Salt Lake City', 'UT', '84150'),
-- 6
 ('Quin Beesley', '6 Eastlawn Lane', null, 'Newark', 'NJ', '07102');
