...
public class HotelController {
 ...
 /**
    ...
    public Hotel get(@PathVariable int id, Principal principal) {

        System.out.println(principal.getName() + " issued a GET /hotels/" + id);
    ...
    public List<Reservation> listReservations(Principal p) {

        String username = p.getName();
        System.out.println(username + " has issued GET /reservations");

        // reservationDao.getReservationsByUsername(username);   // get ONLY reservations belonging to user who requested
