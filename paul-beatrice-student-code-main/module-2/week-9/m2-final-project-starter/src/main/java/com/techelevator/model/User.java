...
public class User {
   ...
   public User(int id, String username, String hashedPassword, String role, String name) {
      this.id = id;
   ...
   public User(String username, String hashedPassword, String role, String name) {
      this(0, username, hashedPassword, role, name);
   }
   ...
   public void setRoleRaw(String role) {
      this.role = role;
   }
