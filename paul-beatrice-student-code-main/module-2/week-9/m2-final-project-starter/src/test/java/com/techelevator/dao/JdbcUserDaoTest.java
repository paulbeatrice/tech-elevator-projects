...
public class JdbcUserDaoTest extends BaseDaoTest {
    ...
    private static final User USER_3 = new User(3,"user3", "user3", "ROLE_USER", "user3");
    ...
    public void create_user_with_null_username() {
        try {
            dao.createUser(new User(null, USER_3.getHashedPassword(), "ROLE_USER", USER_3.getName()));
    ...
    public void create_user_with_existing_username() {
        try {
            dao.createUser(new User(USER_1.getUsername(), USER_3.getHashedPassword(), "ROLE_USER", USER_3.getName()));
    ...
    public void create_user_with_null_password() {
        try {
            dao.createUser(new User(USER_3.getUsername(), null, "ROLE_USER", USER_3.getName()));
    ...
    public void create_user_creates_a_user() {
        User newUser = new User("new", "user", "ROLE_USER", "new");
