...
public class USCitiesAndParksCLI {
    ...
    private static final String connectionStr = "jdbc:postgresql://localhost:5432/UnitedStates";
    ...
    public static void main(String[] args) {
        ...
        /*
         * TODO: Add connection
         *  You want to hide these credentials using environment variables or other...
         */
    ...
    private void run() {
        /*
         * TODO: Add methods for debugging here
         */

        System.out.println("Enter 2-letter state abbreviations: ");
        String stateAbbreviation = userInput.nextLine();
        State state = this.stateDao.getStateByAbbreviation(stateAbbreviation);
